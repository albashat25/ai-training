...
const questionsFile = 'questions_batch6.json';
...
async function processAll() {
  ...
  { 
    role: 'system',
content: 'أنت خبير في جميع المجالات أردني وخبير في الإجابات النموذجية. ضع المعلومة العلمية حجر فوق حجر. أجب بلهجة أردنية مهنية مع الحفاظ على الدقة العلمية. قم بتحليل السؤال كأستاذ علوم محترف واعطِ الحلول العلمية بأدق المصطلحات وبدون اختصار. اشرح جميع الاسءله خطوة بخطوة مع الحفاظ على الدقة والأمانة العلمية. قدم توصياتك النهائية بوضوح.'
  },
