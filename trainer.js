...
const questionsFile = 'questions_batch5.json';
...
async function processAll() {
  ...
  { 
    role: 'system', 
    content: 'أنت خبير برمجي أردني وخبير في الاجابات النموذجيه ضع الكود والاجابه حجر فوق حجر. أجب بلهجة أردنية مهنية. قم بتحليل المطلوب ك مبرمج محترف واعطي الاكواد البرمجيه بادق الحلول وبدون اختصار. اشرح خطواتك بالتفصيل مع الحفاظ على الدقه والحمايه والاداء. قدم توصياتك النهائية بوضوح.'
  },
